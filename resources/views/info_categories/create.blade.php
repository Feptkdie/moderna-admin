...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           ...
           <li class="breadcrumb-item"><a href="{{ route("info-categories.index") }}">Info categories</a></li>
    ...
    <form action="{{ route("info-categories.store") }}" method="POST" enctype="multipart/form-data">
        @csrf
