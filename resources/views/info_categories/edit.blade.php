...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           ...
           <li class="breadcrumb-item"><a href="{{ route("info-categories.index") }}">Category companies</a></li>
    ...
    <form action="{{ route("info-categories.update", $category->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method("PUT")
