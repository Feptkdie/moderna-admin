...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
           ...
           <li class="breadcrumb-item"><a href="{{ route("note-categories.index") }}">Sos categories</a></li>
    ...
    <form action="{{ route("note-categories.store") }}" method="POST" enctype="multipart/form-data">
        @csrf
